...
ExternalTorqueSensorBroadcaster::ExternalTorqueSensorBroadcaster() : controller_interface::ControllerInterface() {}

CallbackReturn ExternalTorqueSensorBroadcaster::on_init() {
  try {
    auto_declare<std::string>("sensor_name", "");
    auto_declare<std::string>("interface_names.left_joint_a1", "");
    auto_declare<std::string>("interface_names.left_joint_a2", "");
    auto_declare<std::string>("interface_names.left_joint_a3", "");
    auto_declare<std::string>("interface_names.left_joint_a4", "");
    auto_declare<std::string>("interface_names.left_joint_a5", "");
    auto_declare<std::string>("interface_names.left_joint_a6", "");
    auto_declare<std::string>("interface_names.left_joint_a7", "");
    auto_declare<std::string>("interface_names.right_joint_a1", "");
    auto_declare<std::string>("interface_names.right_joint_a2", "");
    auto_declare<std::string>("interface_names.right_joint_a3", "");
    auto_declare<std::string>("interface_names.right_joint_a4", "");
    auto_declare<std::string>("interface_names.right_joint_a5", "");
    auto_declare<std::string>("interface_names.right_joint_a6", "");
    auto_declare<std::string>("interface_names.right_joint_a7", "");
...
controller_interface::InterfaceConfiguration ExternalTorqueSensorBroadcaster::command_interface_configuration() const {
  controller_interface::InterfaceConfiguration command_interfaces_config;
  command_interfaces_config.type = controller_interface::interface_configuration_type::NONE;
  return command_interfaces_config;
}

controller_interface::InterfaceConfiguration ExternalTorqueSensorBroadcaster::state_interface_configuration() const {
...
CallbackReturn ExternalTorqueSensorBroadcaster::on_activate(const rclcpp_lifecycle::State & /*previous_state*/) {
  external_torque_sensor_->assign_loaned_state_interfaces(state_interfaces_);
  return CallbackReturn::SUCCESS;
}

CallbackReturn ExternalTorqueSensorBroadcaster::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/) {
  external_torque_sensor_->release_interfaces();
  return CallbackReturn::SUCCESS;
}

controller_interface::return_type ExternalTorqueSensorBroadcaster::update(const rclcpp::Time & /* time */,
...
PLUGINLIB_EXPORT_CLASS(external_torque_sensor_broadcaster::ExternalTorqueSensorBroadcaster,
