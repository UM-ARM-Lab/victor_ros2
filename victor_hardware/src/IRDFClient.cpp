...
//******************************************************************************
void IRDFClient::setTargetJointPosition(std::span<double> target_joint_position)
{
...
//******************************************************************************
void IRDFClient::setTargetJointTorque(std::span<double> target_joint_torque)
{
...
//******************************************************************************
void IRDFClient::getRobotJointPosition(std::span<double> jp)
{
   for (auto i = 0ul; i < jp.size(); i++)
      jp[i] = _iiwaStatus.measuredJointPosition[i];
}
//******************************************************************************
void IRDFClient::getRobotJointVelocity(std::span<double> jv)
{
   for (auto i = 0ul; i < jv.size(); i++)
      jv[i] = _iiwaStatus.estimatedJointVelocity[i];
}
//******************************************************************************
void IRDFClient::getRobotJointTorque(std::span<double> jf)
{
   for (auto i = 0ul; i < jf.size(); i++)
      jf[i] = _iiwaStatus.filteredTorque[i];
}
//******************************************************************************
void IRDFClient::getRobotJointExternalTorque(std::span<double> jet)
{
